...
func (m *MockCategoryRepository) FindAll(arg0 context.Context) ([]Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockCategoryRepository) FindAllByIDs(arg0 context.Context, arg1 interface{}) ([]Category, error) {
	m.ctrl.T.Helper()
