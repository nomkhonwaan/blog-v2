...
@Component({
  ...
  template: `
    ...
    <div class="published-at">{{post.publishedAt | dateFormat}}&nbsp;<span *ngIf="post.categories.length > 0">on</span>&nbsp;<app-post-categories class="app-post-categories" [post]="post"></app-post-categories></div>
  `,
  styles: [
    `
      :host {
